...
def test_when_change_then_heap_size_changes_and_invariant_maintained() -> None:
    ...
    player3 = Player(player_id=3, skill=200)
    player4 = Player(player_id=4, skill=300)
...
def test_when_game_already_in_heap_then_value_is_updated() -> None:
    ...
    updated_candidate_game = CandidateGame(anchor_player=player1, team_x={player1}, team_y={player2}, p_norm=1.0, q_norm=2.0, fairness_weight=0.2)
